...
image_url = "https://www.bitsatom.com/assets/images/bitsatom/color_logo_ba.png"
st.sidebar.image(image_url, caption='Technology in each bit!')

st.title("Assessment / Evaluation using Knowledge Bases for Amazon Bedrock")
